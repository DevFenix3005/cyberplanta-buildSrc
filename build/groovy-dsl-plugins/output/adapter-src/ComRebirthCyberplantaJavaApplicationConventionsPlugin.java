...
/**
 * Precompiled com.rebirth.cyberplanta.java-application-conventions script plugin.
 **/
public class ComRebirthCyberplantaJavaApplicationConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_ComRebirthCyberplantaJavaApplicationConventions").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("com.rebirth.cyberplanta.java-common-conventions");
            target.getPluginManager().apply("org.springframework.boot");
            target.getPluginManager().apply("io.spring.dependency-management");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_ComRebirthCyberplantaJavaApplicationConventions").asSubclass(BasicScript.class);
